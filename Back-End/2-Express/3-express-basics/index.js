...
app.get("/", (req, res) => {
  res.status(200).send("<h1>Response from Express</h1>");
});

app.get("/about", (req, res) => {
  res.status(200).send("<h1>Response from About Pages</h1>");
});

app.get("/projects", (req, res) => {
  res.status(200).send("<h1>Response from Projects Pages</h1>");
});

app.get("/contact", (req, res) => {
  res.status(200).send("<h1>Response from Contact Pages</h1>");
});
